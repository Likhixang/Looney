/**
 * Update：2024-04-27 12:44:26
 * Sub-Store Rename
 * 
 *
 ***Identification 
 * [Int=] Identify the node name type,The priorities are: ZH-cn -> US-en -> Regional-flag -> Full-name
 * [Kun] Keep unmatched nodes
 * [Int=ZH-cn] Identify Chinese keywords
 * [Int=US-en] Identify English keywords
 * [Int=Regional-flag] Identify regional flags
 * [Int=Full-name] Identify full name
 *
 * [Out=]   Output node name optional parameter: For example, out=ZH-cn,out=US-en...The default output is the full English name
 * 
 *** Delimiter
 *
 * [DelimiterNAF=]   节点名前缀或国旗分隔符，默认为空格；
 * [DelimiterRAN=]    设置国家与序号之间的分隔符，默认为空格；
 * 序号参数
 * [one]    清理只有一个节点的地区的01
 * [flag]   给节点前面加国旗
 *
